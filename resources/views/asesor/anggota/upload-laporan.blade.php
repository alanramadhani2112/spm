...
@section('title', 'Upload Laporan — Anggota Asesor')
@section('pageTitle', 'Upload Laporan Individu')
...
<div class="d-grid gap-6">
    ...
    <x-metronic.card title="Upload Laporan Individu">
        ...
        <form method="POST" action="{{ route('asesor.anggota.upload-laporan-individu', $akreditasi->id) }}" enctype="multipart/form-data" class="mt-6">
            @csrf
